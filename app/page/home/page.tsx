'use client'
import NavBar from "@/app/share/nav/page";
...
import SliderOne from "@/app/doc/homeOne/sliderOne"
...
export default function Home() {
    ...
    return (
        <div className='w-full h-full relative overflow-x-clip' >
            <div className={scroll?'translate-y-[-500px]':'translate-y-0 ease-in-out duration-300 absolute flex justify-center items-center w-full h-[100px] bg-gray-500 z-50 top-[calc(100vh-100px)] left-0'}
