'use client'
import SliderTh from "@/app/doc/hometh/sliderTh";
...
import NavTh from "@/app/share/nav/navTh";
    ...
    return (
        <div className='w-full h-full'>
            <div className={scroll?'translate-y-[-500px]':'translate-y-0 ease-in-out duration-300 absolute flex justify-center items-center w-full h-[150px] bg-gray-500 z-50 top-[calc(100vh-150px)] left-0'}
                ...
                <div className='w-full h-[600px] 2xl:h-[calc(100vh-90px)]  mm:h-[450px] smm:h-[250px]'>
                    <NavTh/>
                    <SliderTh/>
                </div>
                <Brands/>
